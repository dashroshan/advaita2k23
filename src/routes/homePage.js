        ...
        <div className={classes.homePage}>
            ...
            <section className={classes.proNights} id="pronights">
                ...
                <div className={classes.proCardsWrap}>
                    {proNightsCard(pn_ss, "2ND MARCH", "SWATI SACHDEVA", "COMEDY", "Get ready for a night of belly laughs and endless giggles. Swati Sachdeva with her quick-witted sets and unique perspective is taking the stand-up comedy scene by storm. Whether she's poking fun at everyday situations or sharing hilarious anecdotes of her life, Swati's comedy is sure to have you in stitches.")}
                    {proNightsCard(pn_bp, "3RD MARCH", "BAND PARASHARA", "CONCERT", "Band PARASHARA are a progressive Delhi-based band. The rock atmospshere conceived by them is sure to leave everyone pumped up and asking for more. Using a great amount of flavors from multiple playing styles and genres, they'll surely take the night high with us.")}
                    {proNightsCard(pn_dc, "4TH MARCH", "DJ CARNIVORE", "EDM", "DJ Carnivore - an EDM artist - is ready to take Advaita to the next level! With his electrifying mixes and heart-pumping beats, he is guaranteed to have all your movements in sync to his beats. So, grab your friends and get ready to let loose as you experience the wild hymns of DJ Carnivore!")}
                    {proNightsCard(pn_ak, "5TH MARCH", "ASEES KAUR", "MUSIC", "Asees Kaur is famous all over India for her major hits like Raataan Lambiyan, Jaan Nisar, and Makhna to name a few. Whether she's belting out Bollywood hits or giving a new spin to classic songs, she'll leave you mesmerized. So, get ready to dance and sing as you experience her electrifying performance.")}
                </div>
            </section>
