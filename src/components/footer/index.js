    ...
    return (
        <>
            <section className={classes.contactsSection} id="contacts">
                ...
                <div>
                    <motion.div viewport={{ once: true }} initial={{ transform: 'translateY(4rem)', opacity: 0 }} whileInView={{ transform: 'translateY(0rem)', opacity: 1 }} transition={{ duration: 1.5, type: "spring", delay: 0.2 }} className={classes.socialContact}><a target="_blank" href="tel:+919876543210">+91 9876543210</a></motion.div>
                ...
                <motion.div viewport={{ once: true }} initial={{ transform: 'translateX(10rem)', opacity: 0 }} whileInView={{ transform: 'translateX(0rem)', opacity: 1 }} transition={{ duration: 1.5, type: "spring", delay: 0.00 }}><a target="_blank" href="mailto:advaita@iiit-bh.ac.in"><AngleButton text="SEND US AN EMAIL" /></a></motion.div>
            </section>
